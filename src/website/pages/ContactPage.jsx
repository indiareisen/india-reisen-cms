        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '3rem' }}>
          ...
          <div>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button type="submit" style={{ width: '100%', padding: '1rem', backgroundColor: '#d1356f', color: 'white', border: 'none', borderRadius: '6px', fontSize: '1.1rem', fontWeight: '700', cursor: 'pointer' }}>Send Message</button>
            </form>
          </div>
          ...
          <div>
            ...
            <div style={{ backgroundColor: 'white', padding: '2rem', borderRadius: '12px', marginBottom: '1.5rem', boxShadow: '0 2px 8px rgba(0,0,0,0.1)' }}>
              <h3 style={{ fontSize: '1.2rem', fontWeight: '700', color: '#d1356f', marginBottom: '0.5rem' }}>📧 Email</h3>
              <p style={{ color: '#666', fontSize: '0.95rem' }}>team@indiareisen.com</p>
            </div>

            <div style={{ backgroundColor: 'white', padding: '2rem', borderRadius: '12px', marginBottom: '1.5rem', boxShadow: '0 2px 8px rgba(0,0,0,0.1)' }}>
              <h3 style={{ fontSize: '1.2rem', fontWeight: '700', color: '#d1356f', marginBottom: '0.5rem' }}>📞 Phone</h3>
              <p style={{ color: '#666', fontSize: '0.95rem' }}>+91 98108 27785</p>
              <p style={{ color: '#999', fontSize: '0.85rem', marginTop: '0.5rem' }}>Monday - Friday, 9:00 AM - 6:00 PM IST</p>
            </div>

            <div style={{ backgroundColor: 'white', padding: '2rem', borderRadius: '12px', marginBottom: '1.5rem', boxShadow: '0 2px 8px rgba(0,0,0,0.1)' }}>
              <h3 style={{ fontSize: '1.2rem', fontWeight: '700', color: '#d1356f', marginBottom: '0.5rem' }}>📍 Address</h3>
              <p style={{ color: '#666', fontSize: '0.95rem' }}>Ghaziabad, Uttar Pradesh<br/>India</p>
            </div>

            <div style={{ backgroundColor: 'white', padding: '2rem', borderRadius: '12px', boxShadow: '0 2px 8px rgba(0,0,0,0.1)' }}>
              <h3 style={{ fontSize: '1.2rem', fontWeight: '700', color: '#d1356f', marginBottom: '1rem' }}>📱 Follow Us</h3>
              <div style={{ display: 'flex', gap: '1rem' }}>
                <a href="https://instagram.com/indiareisen" target="_blank" rel="noopener noreferrer" style={{ fontSize: '2rem', textDecoration: 'none' }}>📸</a>
                <a href="https://facebook.com/indiareisen" target="_blank" rel="noopener noreferrer" style={{ fontSize: '2rem', textDecoration: 'none' }}>👥</a>
                <a href="https://twitter.com/indiareisen" target="_blank" rel="noopener noreferrer" style={{ fontSize: '2rem', textDecoration: 'none' }}>𝕏</a>
                <a href="https://youtube.com/indiareisen" target="_blank" rel="noopener noreferrer" style={{ fontSize: '2rem', textDecoration: 'none' }}>▶️</a>
              </div>
            </div>
          </div>
        </div>
